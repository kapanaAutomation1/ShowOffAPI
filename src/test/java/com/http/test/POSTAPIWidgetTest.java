...
import ShowOffTask.TestBase;
	...
	public class POSTAPIWidgetTest extends TestBase {
		TestBase testBase;
		String apiurl;
		String serviceUrl;
		String uri;
		...
		public POSTAPIWidgetTest() throws Exception {
			super();
		...
		public void setUp() throws Exception {
			...
			serviceUrl= prop.getProperty("createWidgetsURL");
		...
		@Test
		 public void postAPIMethodTest()throws ClientProtocolException, IOException, ParseException {
		   ...
		   // headerMap.put("Authorization","Bearer 682780b40b57e1fa493ff6e6e20aef36ed52ee199c5ed34b4093532581998da3");
		    ...
		    Object obj = parser.parse(new FileReader("src/main/resources/Payloads/CreateWidgetPayload.json"));
		    	
		     //java object to json in to string 
		    ...
		    System.out.println("g usersJsonString"+usersJsonString);
			 ...
			 String DESC= TestUtil.getValueByJpath(Widget,"description");
